...
1. An `observation` model, a function from Eta to a monadic distribution `Rand` with a `draw` method
...
4. A definition of the initial State, `x0`, a monadic distribution `Rand`
