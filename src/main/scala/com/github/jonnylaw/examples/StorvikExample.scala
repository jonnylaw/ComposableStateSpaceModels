...
// /**
//   * Run the Storvik Filter on the linear model with unknown observation variance
//   */
...
//       for {
//         precision <- x.dist
//       } yield LeafParameter(GaussianParameter(0.1, 1.0),
//         Some(1.0/precision),
//         BrownianParameter(-0.2, 1.0))
//   }
...
// /**
//   * Run the Storvik Filter on the linear model with unknown system variance
//   */
// object StorvikUnknownSystemVariance extends App with LinearModel {
//    implicit val system = ActorSystem("Storvik")
//   implicit val materializer = ActorMaterializer()
...
//       } yield LeafParameter(GaussianParameter(0.1, 1.0),
//         s.scale,
//         BrownianParameter(-0.2, 1.0/system_prec))
//   }

//   val pf = StorvikFilterUnknownSystemVariance(unparamMod, proposal, 10000, Gamma(0.25, 4.0))
