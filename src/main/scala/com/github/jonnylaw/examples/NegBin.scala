...
//       val pmmh = MetropolisHastings.pmmhState(simPrior.draw,
...
//       val filter = ParticleFilter.llStateReader(d.toVector, resample, 100)
//       val pf = (filter compose model)
//       val pmmh = MetropolisHastings.pmmhState(post._2,
//         Parameters.perturbMvn(cholesky(scale * scale * post._1)), (a, b) => 0.0, prior)
